let awl = [
    ...
    },
    {
      ...
      definitions: [
        ...
        {
          part: "null",
          definition: "of or made from or using substances produced by or used in reactions involving atomic or molecular changes"
        }
      ],
      Examples: [
        "chemical engineer",
    ...
    },
    {
      ...
      definitions: [
        ...
        {
          part: "null",
          definition: "(physics) of waves having a constant phase relation"
        }
      ],
      Examples: [
        "two coherent sheets",
    ...
    },
    {
      ...
      definitions: [
        ...
        {
          part: "null",
          definition: "in accordance with scientific laws"
        }
      ],
      Examples: [
    ...
    },
    {
      ...
      definitions: [
        ...
        {
          part: "null",
          definition: "have (one's work) issued for publication"
        }
      ],
      Examples: [
    ...
    },
    {
      ...
      definitions: [
        ...
        {
          part: "noun",
          definition: "(basketball) a foul that can be assessed on a player or a coach or a team for unsportsmanlike conduct; does not usually involve physical contact during play"
        },
        {
          part: "adjective",
          definition: "of or relating to or requiring special knowledge to be understood"
        ...
        {
          part: "null",
          definition: "characterizing or showing skill in or specialized knowledge of applied arts and sciences"
        },
        {
          part: "null",
          definition: "according to strict interpretation of the law or set of rules"
        }
      ],
      Examples: [
        "technical college",
...
//         .then(response => {
//             awl[index].Examples=response.examples
//         }) 
...
function getWord() {
  closeDropdown()
  // choose random word, sublist and related word forms
  tabs.innerHTML=''
  tabsContent.innerHTML=''
  examples.innerHTML=''
  const arrayLength = awl.length
  let randInt = Math.floor(Math.random() * arrayLength)
  let word = awl[randInt].HeadWord
